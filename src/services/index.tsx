...
export default [
  ...
  content: (
    <>
      ...
      <p>
        Existem diversos sinais que podem indicar que sua bateria está chegando ao fim, incluindo:
      </p>
...
},
{
  ...
  content: (
    <>
      ...
      <p>
        Um carro que não liga pode ser resultado de várias causas, incluindo:
      </p>
      ...
      <h2>Como Resolver</h2>
      <p>
        Para solucionar o problema de um carro que não liga, é importante seguir alguns passos:
      </p>
      ...
      <p>
        ...
        complexas. É fundamental realizar uma análise cuidadosa e, se necessário, contar com a ajuda de um profissional
        qualificado para diagnosticar e resolver o problema de forma eficiente.
      </p>
    </>
  )
},
